    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='product.jpg', upload_to='product-image')),
                ('decription', models.TextField(blank=True, default='This is the product', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=999)),
                ...
                ('life', models.CharField(blank=True, default='1 month', max_length=100, null=True)),
                ('mfd', models.DateTimeField(blank=True, null=True)),
                ('product_status', models.CharField(choices=[('draft', 'Draft'), ('disabled', 'Disapled'), ('reject', 'Rejected'), ('in_review', 'In Review'), ('published', 'Published')], default='in_review', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Nesto', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('decription', models.TextField(blank=True, default='I am  an amazing vendor', null=True)),
                ('address', models.CharField(default='123 Street Road', max_length=200)),
                ('contact', models.CharField(default='+91-000000', max_length=100)),
